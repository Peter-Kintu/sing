...
# KAIBER_VIDEO_API_URL = "https://kaiber.ai/api/video"        # Video generation disabled for now
...
#     print(f"🎬 Skipping video generation for SongRequest ID {song_request_id}")
#     return "Video generation is currently disabled."